...
A admitância de entrada de um \textit{stub} em aberto de comprimento $\lambda/8$ ($45^{\circ}$) é dada por $Y_{in} = j Y_0 \tan(45^{\circ})$. Logo, a admitância dos \textit{stubs} no modo par assume o valor:
